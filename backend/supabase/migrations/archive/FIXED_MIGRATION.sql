-- Fixed Migration - Copy and paste this entire block into Supabase SQL Editor

-- 1. Create get_quote function
...
-- 2. Create get_user_context function
...
-- 4. Create get_recommendations function
...
-- 5. Create market_news table first
...
-- 7. Create get_market_news function
...
-- 8. Create get_ai_health function
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.market_news TO anon, authenticated, service_role;
