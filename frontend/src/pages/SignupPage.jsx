      ...
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="w-full max-w-md relative z-10">
        <Card className="p-8">
          <div className="text-center mb-6">
            <h1 className="text-3xl font-semibold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-accent-500 to-accent-700">Create your account</h1>
            <p className="text-neutral-600 mt-2">Join and start your learning journey</p>
          </div>
          <SignupForm />
        </Card>
      </motion.div>
