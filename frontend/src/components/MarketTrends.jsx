...
const MarketTrends = () => {
  ...
  const renderMarketIndices = () => (
    <Grid container spacing={2} sx={{ mb: 4 }}>
      {marketIndices && Object.entries(marketIndices).map(([key, index]) => (
          ...
          <Card variant="outlined">
            <CardContent>
              <Box display="flex" justifyContent="space-between" alignItems="center">
                ...
                >
                  {index.change >= 0 ? <TrendingUpIcon /> : <TrendingDownIcon />}
                ...
                <Box mt={1}>
                  <Box
                    sx={{
                      height: 4,
                      borderRadius: 2,
                      bgcolor: sector.changePercent >= 0 ? 'success.light' : 'error.light',
  ...
  return (
    <Container maxWidth="xl" sx={{ py: 3 }}>
      <Box sx={{ borderBottom: 1, borderColor: 'divider', mb: 3 }}>
        ...
        >
          <Tab label="Market Overview" icon={<BarChartIcon />} iconPosition="start" />
                ...
                <Box>
                  ...
                  >
                    <Typography color="textSecondary">
                      Interactive chart for {selectedStock} will be displayed here
                    </Typography>
                  </Box>
