  ...
  const questions = [
    {
      ...
      options: ["Higher returns", "Reduced risk", "Lower taxes", "Faster growth"],
      correct: 1
    },
    {
    ...
    return (
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-lg shadow-sm border p-8 text-center">
          ...
          <p className="text-2xl text-blue-600 mb-4">{score}/{questions.length}</p>
          <p className="text-gray-600 mb-6">You scored {Math.round((score/questions.length) * 100)}%</p>
          <button 
            onClick={() => {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="bg-white rounded-lg shadow-sm border p-8">
        <h1 className="text-2xl font-bold text-gray-900 mb-6">Investment Knowledge Quiz</h1>
        <div className="mb-4">
