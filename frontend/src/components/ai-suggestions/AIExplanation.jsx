  ...
  const renderTabContent = () => {
    switch (activeTab) {
        ...
        return (
          <div className="space-y-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              {suggestion.reasoning || 'Our AI analyzed your portfolio composition, risk tolerance, and current market conditions to generate this recommendation.'}
            </p>
            
            <div className="bg-blue-50 p-4 rounded-lg">
              <h4 className="font-medium text-blue-900 mb-2">Key Considerations:</h4>
      ...
      case 'factors':
        return (
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-gray-900">Market Factors Analysis</h3>
      ...
      case 'risks':
        return (
          <div className="space-y-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              {suggestion.riskAssessment || 'This recommendation has been evaluated against your risk tolerance and portfolio objectives.'}
            </p>
            
            <div className="space-y-4">
              <div className="bg-yellow-50 p-4 rounded-lg">
                <h4 className="font-medium text-yellow-900 mb-2">Risk Level: {suggestion.riskLevel || 'Medium'}</h4>
                <p className="text-yellow-800 text-sm">
                  Based on your risk tolerance profile and current market conditions.
                </p>
              </div>
              
              <div className="bg-gray-50 p-4 rounded-lg">
                <h4 className="font-medium text-gray-900 mb-2">Risk Mitigation Strategies</h4>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-gray-700 text-sm">
                  {suggestion.shortTermOutlook || 'Short-term outlook based on current market conditions and technical indicators.'}
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 text-sm">
                  {suggestion.longTermOutlook || 'Long-term outlook considering fundamental analysis and growth prospects.'}
                </p>
              </div>
            </div>
            ...
            <div className="bg-blue-50 p-4 rounded-lg">
              ...
              <p className="text-blue-800 text-sm">
                All predictions and forecasts are based on historical data and current market analysis. 
                Past performance does not guarantee future results. Always consider your own research 
