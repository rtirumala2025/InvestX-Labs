    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        ...
        <div className="flex items-start justify-between">
          ...
          <div
            className={`px-3 py-1 rounded-full text-sm font-medium ${getConfidenceColor(suggestion.confidence)}`}
          >
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-gray-600">
                  {suggestion.reasoning || "Detailed reasoning not available."}
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600">
                  {suggestion.shortTermOutlook ||
                    "Short-term outlook not available."}
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600">
                  {suggestion.longTermOutlook ||
                    "Long-term outlook not available."}
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p
                    className={`text-lg font-semibold ${suggestion.priceChange >= 0 ? "text-green-600" : "text-red-600"}`}
                  >
