...
const AISuggestions = ({ onAction }) => {
  ...
  const defaultSuggestions = [
    {
      ...
      details:
        "Apple has shown consistent revenue growth and has a strong product pipeline with the upcoming iPhone 15 and new services. The stock is currently trading at a reasonable valuation relative to its peers.",
      priceTarget: 195.0,
      currentPrice: 175.5,
      upside: 11.1,
    },
    {
      ...
      details:
        "Microsoft continues to show strength in its cloud computing business with Azure. While growth is steady, current valuation appears fair relative to growth prospects.",
      priceTarget: 340.0,
      currentPrice: 315.25,
      upside: 7.9,
    },
    {
      ...
      details:
        "Tesla faces increasing competition in the EV market, and its current valuation appears stretched relative to traditional automakers and even other high-growth tech companies.",
      priceTarget: 150.0,
      currentPrice: 165.3,
      downside: 9.3,
    },
  ...
  const displaySuggestions =
    recommendations?.length > 0 ? recommendations : defaultSuggestions;
  ...
  const getConfidenceBadge = (confidence) => {
    ...
    const { color, text } = confidenceMap[confidence] || {
      color: "gray",
      text: "Unknown",
    };
  ...
  const getActionButton = (suggestion) => {
    const baseClasses =
      "px-3 py-1 text-sm font-medium rounded-md focus:outline-none";
    ...
    <div className="bg-white rounded-lg shadow-sm border overflow-hidden">
        ...
        {displaySuggestions.map((suggestion) => (
          ...
          >
            <div className="flex justify-between items-start">
                      ...
                      <div className="grid grid-cols-2 gap-2 text-xs">
                        <div>
                          ...
                          <span className="font-medium">
                            ${suggestion.currentPrice?.toFixed(2) || "N/A"}
                          </span>
                        </div>
                        <div>
                          Target Price:{" "}
                          <span className="font-medium">
                            ${suggestion.priceTarget?.toFixed(2) || "N/A"}
                          </span>
                        </div>
                        <div>
                          Upside/Downside:{" "}
              ...
              <div
                className={`text-right ${suggestion.type === "sell" ? "text-red-600" : "text-green-600"}`}
              >
      ...
      <div className="p-4 bg-gray-50 text-center border-t">
        <p className="text-xs text-gray-500">
          AI suggestions are based on your risk profile and market conditions.
