  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border overflow-hidden">
      <div className="p-6 border-b">
        ...
        <p className="text-sm text-gray-500 mt-1">Frequently used actions to manage your investments</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 p-4">
        {actions.map((action) => (
          ...
          >
            <div className={`p-2 rounded-lg ${action.color} ${action.textColor} mr-3`}>
              {action.icon}
            </div>
            <div>
