...
const QuickStats = ({ portfolio }) => {
  const { totalValue, totalGainLoss, totalGainLossPercentage } = portfolio || {};
      ...
      <div className="bg-white rounded-lg shadow-sm border p-6">
        <div className="flex items-center">
          ...
          <div className="ml-4">
            ...
            <p className={`text-2xl font-semibold ${getGainLossColor(totalGainLoss)}`}>
        ...
        <div className="flex items-center">
          <div className="flex-shrink-0">
            <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${
              ...
              <svg className={`w-5 h-5 ${totalGainLossPercentage >= 0 ? 'text-green-600' : 'text-red-600'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="ml-4">
            ...
            <p className={`text-2xl font-semibold ${getGainLossColor(totalGainLossPercentage)}`}>
