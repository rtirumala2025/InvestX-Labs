...
const ChatInterfaceDemo = () => {
  ...
  const handleAIMessage = useCallback(async (userMessage) => {
    console.log('💬 [ChatInterfaceDemo] Sending message to AI:', userMessage);
    
    if (!aiConfigured) {
      console.warn('💬 [ChatInterfaceDemo] ⚠️ AI not configured, using fallback response');
      return {
    ...
    try {
      ...
      const suggestions = portfolioData.holdings.length > 0 
        ? [
  ...
  const handleSendMessage = useCallback(async () => {
    ...
    try {
      ...
      console.log('💬 [ChatInterfaceDemo] Adding assistant message to conversation');
      setMessages(prev => [...prev, assistantMessage]);
      
    } catch (error) {
      console.error('💬 [ChatInterfaceDemo] ❌ Error in message handling:', error);
  ...
  const handleResetConversation = () => {
    ...
    const welcomeMessage = {
      id: uuidv4(),
      type: MESSAGE_TYPES.ASSISTANT,
      content: 'Hello! I\'m Finley, your AI investment education assistant. I can help you understand investing concepts, analyze markets, and make informed financial decisions. What would you like to learn about today?',
      timestamp: new Date().toISOString(),
      suggestions: [
        'What are the basics of stock market investing?',
        'How do I build a diversified portfolio?',
      ...
      >
        <div className="message-content">
          ...
          <div className="message-bubble">
            ...
            {message.suggestions && message.suggestions.length > 0 && !isSystem && (
  ...
  const renderWelcomeMessage = () => (
    <div className="welcome-message">
      <div className="welcome-header">
        ...
        <p>I'm Finley, your AI-powered investment education assistant. I can help you understand complex financial concepts, analyze market trends, and make informed investment decisions.</p>
      </div>
        ...
        <div className={`chat-header ${isMinimized ? 'minimized' : ''}`}>
          <div className="header-content">
            <div className="header-info">
              ...
              <p>{isMinimized ? 'Click to chat' : 'Your personal investment guide'}</p>
            </div>
            ...
            <div className="header-actions">
              ...
              >
                {isMinimized ? <FiMessageSquare size={18} /> : <FiChevronDown size={18} />}
              </button>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="chat-interface-container">
      <div className={`chat-header ${isMinimized ? 'minimized' : ''}`} onClick={() => isMinimized && setIsMinimized(false)}>
        <div className="header-content">
          <div className="header-info">
