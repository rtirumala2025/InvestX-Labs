    ...
    options: [
      {
        ...
        text: "Preserve capital with steady income",
        score: 1,
      },
      {
        value: "moderate_growth",
        text: "Moderate growth with some income",
        score: 2,
      },
      {
        value: "balanced_growth",
        text: "Balanced growth and income",
        score: 3,
      },
    ...
    options: [
      {
        ...
        text: "Very uncomfortable - prefer stability",
        score: 1,
      },
      {
      ...
      {
        value: "moderately_comfortable",
        text: "Moderately comfortable",
        score: 3,
      },
      {
        value: "very_comfortable",
        text: "Very comfortable - volatility means opportunity",
        score: 4,
      },
    ],
  },
  {
    ...
    options: [
      { value: "beginner", text: "Beginner - need guidance", score: 1 },
      {
        ...
        text: "Some knowledge - learning more",
        score: 2,
      },
      {
        value: "intermediate",
        text: "Intermediate - understand basics",
        score: 3,
      },
      {
        value: "advanced",
        text: "Advanced - comfortable with complex strategies",
        score: 4,
      },
    ],
  },
